<x-layouts.app :title="$title ?? 'Teacher'">
    ...
    <flux:sidebar sticky stashable class="bg-[#111111] border-r border-[#2a2a2a]">
        ...
        <div class="flex items-center gap-3 px-4 py-5 border-b border-[#2a2a2a]">
            <div class="w-8 h-8 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex items-center justify-center shadow-[0_0_12px_rgba(16,185,129,0.15)]">
                <flux:icon.academic-cap class="w-5 h-5 text-emerald-400" />
            </div>
            <div>
                <p class="text-sm font-bold text-[#ededed]">Teacher Portal</p>
    ...
    <flux:main>
        <header class="sticky top-0 z-10 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-[#2a2a2a] px-6 py-4 flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                <span class="text-[10px] bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-2.5 py-1 rounded-full font-bold uppercase tracking-widest">Teacher</span>
